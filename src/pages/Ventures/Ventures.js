...
const ventures = [
  ...
  },
  {
    ...
    logo: "./images/starlight-logo.png",
    desc: "Innovative IT solutions driving transformation",
    link: "https://starlighttechlabs.com",
  },
  {
    name: "Crescent Electronics Pvt. Ltd.",
    logo: "./images/crescent.png",
                ...
                <div className="card portfolio-card h-100 text-center border-0 shadow-lg">
                  <div className="card-body">
                    <img
                      src={v.logo}
                      alt={v.name}
                      className="img-fluid  w-50 mb-3 venture-logo"
                    />
