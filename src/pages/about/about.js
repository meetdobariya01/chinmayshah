...
const expertiseItems = [
  {
    ...
    text: "Exploring, understanding, and implementing the next wave of intelligent technologies.",
  },
  {
    icon: <FaRocket />,
  ...
  },
  {
    ...
    text: "Driving enterprise transformation through agile innovation frameworks and digital strategies.",
  },
  {
    icon: <FaMicrochip />,
    title: "Electronics & Semiconductors",
    text: "Building strong technical foundations in advanced electronics and hardware engineering.",
  },
  {
    icon: <FaChartLine />,
    title: "Investor Relations",
    text: "Connecting visionary technology-driven startups with strategic capital and investment networks.",
  },
  {
    icon: <FaGraduationCap />,
    title: "Education & Ecosystem Building",
    text: "Nurturing future talent and fostering sustainable technology-driven innovation ecosystems.",
  },
];
...
const timelineData = [
  {
    icon: <FaBuilding />,
    title: "Crescent Electronics Pvt. Ltd.",
    text: "Company Established 1984, I joined 1997 Laid the foundation in the world of electronics, technology, and innovation.",
  },
  {
    icon: <FaRocket />,
    title: "Startup Steroids",
    text: "Accelerating entrepreneurial growth through startup mentorship, ecosystem building, and technology-driven programs.",
  },
  {
    icon: <FaLightbulb />,
    title: "HorseTech Analytics",
    text: "A technology-driven company focused on building secure, efficient, and future-ready digital products.",
  },
  {
    icon: <FaHandshake />,
    title: "Starlight Tech Labs",
    text: "Delivering innovative IT solutions, scalable software, automation, and digital transformation.",
  },
  {
    icon: <FaRobot />,
    title: "Accomation",
    text: "An AI-powered accounting automation platform simplifying bookkeeping, compliance, and financial workflows.",
  },
];
export const About = () => {
    ...
    <div>
      ...
      <section className="vision-section d-flex align-items-center justify-content-center text-center">
        <div className="container">
          ...
          >
            ...
            >
              “Technology isn’t just transforming industries, it’s redefining
      ...
      <section className="collab-section d-flex align-items-center justify-content-center text-center">
        <div className="container">
          ...
          >
            Whether you are building the next big innovation, shaping bold
            ideas, or creating meaningful impact - let’s make it happen
            together.
          </motion.p>
