        ...
        <Container>
          <Row className="gy-4">
            ...
            <Col md={4} className="text-center">
              <motion.blockquote
                ...
                viewport={{ once: true }}
              >
                “Empowering ideas. Enabling innovation. Shaping the future.”
              </motion.blockquote>
            </Col>
            ...
            <Col md={4} className="text-center text-md-end">
              ...
              >
                ...
                <a
                  href="https://twitter.com/chinmay_shah"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FaTwitter />
                ...
                <a
                  href="https://www.instagram.com/chinmayushah/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FaInstagram />
          ...
          <Row>
            <Col className="text-center">
              ...
              >
                © 2025{" "}
                <span className="fw-bold text-gradient">Chinmay U. Shah</span>,
                All Rights Reserved.
              </motion.p>
            </Col>
          </Row>
